...
CREATE TABLE estoque (
    isbn_fk    VARCHAR(20) PRIMARY KEY,
    quantidade INT NOT NULL,
    status     VARCHAR(20) NOT NULL,
    CONSTRAINT fk_estoque_livro
      FOREIGN KEY (isbn_fk) REFERENCES livros (isbn)
);
...
INSERT INTO biblioteca_online.usuarios (nome, email, senha) VALUES
    ('Administrador', 'admin@bibliotech.com', '123456'), -- ID 1
    ('Ana Silva',     'ana@email.com',       '123456'), -- ID 2
    ('João Santos',    'joao@email.com',      '123456'); -- ID 3
...
INSERT INTO biblioteca_online.emprestimos (id_emprestimo, id_usuario_fk, isbn_fk, data_emprestimo, data_devolucao) VALUES
    (1, 2, '970', '2026-09-01', '2026-09-01'),
    (2, 3, '973', '2026-08-20', '2026-08-28'),
    (3, 2, '974', '2026-08-29', '2026-09-05'),
    (4, 3, '975', '2026-08-22', '2026-08-30');
